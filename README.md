...
OmKwam 0.34d is a privacy-first experimental workspace for Thai testimony transcription. It can record or import audio, transcribe it with Gemini using the user's own API key, help review uncertain words, and draft a concise testimony summary for human review.
